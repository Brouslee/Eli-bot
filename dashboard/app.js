...
module.exports = async (api) => {
        ...
        const botSettingsRoute = require("./routes/botSettings.js")(paramsForRoutes);
        const commandsRoute = require("./routes/commands.js")(paramsForRoutes);
        ...
        app.use("/dashboard/bot-settings", botSettingsRoute);
        app.use("/dashboard/commands", commandsRoute);
        app.use("/dashboard/music", express.static(`${__dirname}/music`));
